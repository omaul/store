...
export const PRODUCTS: Product[] = [
  {
    ...
    // ЗАГЛУШКА, чтобы было видно кнопку «ОПИСАНИЕ»: заменить настоящим текстом
    // или вернуть пустую строку, тогда кнопки у изделия не будет
    note: 'ЗАГЛУШКА: здесь будет описание изделия — как сделано, из чего, чем отличается. Пара строк, чтобы видеть, как текст встаёт рядом с кадром.',
  },
  {
